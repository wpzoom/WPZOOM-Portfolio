	...
	class WPZOOM_Portfolio_Custom_Posts {
		...
		public function register_custom_post_type() {
			...
			register_post_type(
				...
				array(
					'labels'                 => array(
						'name'               => _x( 'Custom Layouts', 'Post Type General Name', 'wpzoom-portfolio' ),
						'singular_name'      => _x( 'Custom Layout', 'Post Type Singular Name', 'wpzoom-portfolio' ),
						'menu_name'          => _x( 'Custom Layouts', 'Post Type General Name', 'wpzoom-portfolio' ),
						'parent_item_colon'  => __( 'Parent Portfolio Item', 'wpzoom-portfolio' ),
						'all_items'          => __( 'Custom Layouts', 'wpzoom-portfolio' ),
						'view_item'          => __( 'View Custom Layout', 'wpzoom-portfolio' ),
						'add_new_item'       => __( 'Add New Custom Layout', 'wpzoom-portfolio' ),
						'add_new'            => __( 'Add New', 'wpzoom-portfolio' ),
						'edit_item'          => __( 'Edit Custom Layout', 'wpzoom-portfolio' ),
						'update_item'        => __( 'Update Custom Layout', 'wpzoom-portfolio' ),
						'search_items'       => __( 'Search Custom Layout', 'wpzoom-portfolio' ),
