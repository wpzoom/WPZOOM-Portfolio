...
namespace WPZOOMElementorBlockPortfolio;

use Elementor\Plugin;

// Instance the plugin
WPZOOM_Elementor_Block_Portfolio::instance();

/**
 * Class WPZOOM_Elementor_Block_Portfolio
 */
...
class WPZOOM_Elementor_Block_Portfolio {
	 ...
	 * Instance
	 *
	 * @var WPZOOM_Elementor_Block_Portfolio The single instance of the class.
	 * @since 1.0.5
	 * @access private
	 * @static
	 */
	...
	public function plugin_css() {
		wp_enqueue_style( 'wpzoom-elementor-block-portfolio', WPZOOM_PORTFOLIO_URL . 'elementor/assets/css/wpzoom-elementor-block-portfolio.css', WPZOOM_PORTFOLIO_VERSION );
	}
	...
	public function init_widgets() {
		...
		foreach ( $widgets as $path ) {
			...
			if ( file_exists( $file ) ) {
				require_once $file;
				$class_name = '\WPZOOMElementorBlockPortfolio\\' . ucwords( $slug_, '_' );
	...
	function add_widget_categories( $elements_manager ) {
		$elements_manager->add_category(
			'wpzoom-elementor-block-porfolio',
			array(
