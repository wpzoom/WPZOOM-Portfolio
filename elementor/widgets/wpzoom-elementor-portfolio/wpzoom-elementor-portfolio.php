 ...
 * @since 1.0.5
 */
class WPZOOM_Elementor_Portfolio extends Widget_Base {
	...
	public function get_name() {
		return 'wpzoom-elementor-block-portfolio';
	}
	...
	public function get_title() {
		return esc_html__( 'Portfolio', 'wpzoom-portfolio' );
	}
	...
	public function get_categories() {
		return array( 'wpzoom-elementor-block-porfolio' );
	}
