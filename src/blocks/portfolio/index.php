...
class WPZOOM_Blocks_Portfolio {
	...
	public function __construct() {
		...
		if ( is_null( term_exists( 'uncategorized', 'wpzb_portfolio_category' ) ) ) {
			wp_insert_term( esc_html__( 'Uncategorized', 'wpzoom-blocks' ), 'wpzb_portfolio_category', array( 'slug' => 'uncategorized' ) );
		}
	...
	public function list_categories( $only = array() ) {
		...
		if ( ! empty( $categories ) ) {
			...
			$output .= '<li class="wp-block-button cat-item-all current-cat">
				<a href="' . $posts_page . '" class="wpz-portfolio-button__link">' . esc_html__( 'All', 'wpzoom-blocks' ) . '</a>
			</li>';
